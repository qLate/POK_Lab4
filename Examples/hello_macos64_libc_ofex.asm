;	MacOS 64-bit. Self-contained, libc.
;
; Сompile the source:
;	INCLUDE=x86/include ./fasmg.mac hello_macos64_libc_ofex.asm 
;
; Sometimes you will needed:
;	chmod +x fasmg.mac # Before using fasmg.mac
;	chmod +x hello_macos64_libc_ofex  # To execute assembled application
